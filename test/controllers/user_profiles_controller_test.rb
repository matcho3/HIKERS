...
class UserProfilesControllerTest < ActionController::TestCase
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post :create, user_profile: { birthday: @user_profile.birthday, image: @user_profile.image, name: @user_profile.name, user_id: @user_profile.user_id }
    end
  ...
  test "should update user_profile" do
    patch :update, id: @user_profile, user_profile: { birthday: @user_profile.birthday, image: @user_profile.image, name: @user_profile.name, user_id: @user_profile.user_id }
    assert_redirected_to user_profile_path(assigns(:user_profile))
  end
